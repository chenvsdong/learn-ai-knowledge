...
以下来源按 2026-05-29 访问时的官方文档理解；Agent Memory 的具体 API、命名和支持范围以后续官方文档和项目依赖版本为准。
...
- [LangChain Docs: Long-term memory](https://docs.langchain.com/oss/python/deepagents/memory)
