...
这样既能作为系统学习资料，也能逐步沉淀成个人 AI Agent 知识库。
...
- Rerank、多路召回、Query Rewrite
- 引用来源与可解释性
- 如何评估 RAG 效果：召回率、准确率、答案可信度
